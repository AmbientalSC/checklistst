...
const App: React.FC = () => {
    // Use import.meta.env.BASE_URL inline where needed to avoid leaving a global BASE_URL in the build
    // FIREBASE HOOKS
        ...
        <div className="flex items-center justify-center min-h-screen bg-slate-100">
            <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
                <div className="text-center">
                    <img src={`${(import.meta as any).env?.BASE_URL || '/'}ambiental.svg`} alt="Ambiental - TST" className="mx-auto h-16 w-auto mb-4" />
...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, currentUser, unreadCount }) => {
    ...
    return (
        <nav className="w-64 bg-white shadow-lg flex flex-col min-h-screen sticky top-0">
                ...
                <img src={`${(import.meta as any).env?.BASE_URL || '/'}ambiental.svg`} alt="Ambiental - TST" className="h-10 w-auto" />
            </div>
